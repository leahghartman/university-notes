...
We'll first look the the motion of a single particle in constant, homogeneous, electric and magnetic fields. The advantage of doing this is that it's a situation which can be solved exactly, can be used to understand basic properties of numerical solutions, and can be used to understand the normalization of quantities. 

\subsection{Equations of Motion}
For the motion of a particle in 
